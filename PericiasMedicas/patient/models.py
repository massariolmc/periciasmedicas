...
class Patients(models.Model):
    ...
    origin = models.CharField("Procedência",max_length=100, blank=False)
    ...
    blood_type = models.CharField(("Tipo Sanguíneo"), choices=blood_type_choices, max_length=1, blank=True)
