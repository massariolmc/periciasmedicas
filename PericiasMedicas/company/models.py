...
class Company(models.Model):
    name = models.CharField(("Nome"), max_length=100, blank=False, null= False)
    cnpj = models.CharField(("CNPJ"), max_length=14, unique = True, blank=True, help_text="Apenas números")
    state_registration = models.CharField(("Inscrição Estadual"), default="",max_length=100, blank=True, help_text="Apenas números")    
    ...
    address_num = models.CharField(("Número"), max_length=100, blank=False, null= False, help_text="Apenas números")
    address_burgh = models.CharField(("Bairro"), max_length=100, blank=False, null= False)
    state_city = models.CharField(("Cidade/Estado"), max_length=100, blank=False, null= False, help_text="Ex: Campo Grande/MS, Porto Alegre/RS, Vitória/ES, Natal/RN")
    zip_code = models.CharField(("CEP"), max_length=8, blank=True, help_text = "Apenas Números")
